...
namespace MVCBasico.Migrations
{
    ...
    [Migration("20230712011732_Puntos")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MVCBasico.Models.Puntos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<long>("CantPuntos")
                        .HasColumnType("bigint");

                    b.Property<double>("SaldoRemanente")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("MVCBasico.Models.Puntos", b =>
                {
                    b.HasOne("MVCBasico.Models.Usuario", null)
                        .WithOne("Puntos")
                        .HasForeignKey("MVCBasico.Models.Puntos", "UsuarioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
